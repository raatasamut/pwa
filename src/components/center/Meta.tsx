...
function Meta(): JSX.Element {
  return (
    <>
      ...
      {/* KEYWORDS */}
      <meta name="title" content="SHU Progressive Web App Template" />
      <meta
        name="description"
      ...
      <meta
        name="keywords"
        content="Next.js, pwa, React, HTML, CSS, JavaScript, TypeScript, shu, global, it"
      />
      {/* THEMES */}
      ...
      <meta name="apple-mobile-web-app-title" content="SHU PWA" />
      <meta name="application-name" content="SHU PWA" />
      ...
      <meta property="og:url" content="https://shu.global" />
